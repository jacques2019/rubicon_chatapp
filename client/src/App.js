            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-900">
                    {messages.map((message) => (
                        <div key={message.id}>
                            <div className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg bg-gray-800 text-gray-100 shadow-md`}>
                                <p className="text-sm text-purple-400 font-medium">{message.senderName}</p>
